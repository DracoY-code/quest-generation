...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{training_train_losses.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{training_grad_norms.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{generation_perplexity.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{generation_text_metrics.png}
